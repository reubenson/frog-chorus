...
<main class="font-serif text-center tracking-wider pb-6 text-{colors.main}">
  ...
  <div class="-z-20 bg-{colors.background} fixed left-[-100px] right-[-100px] top-[-100px] bottom-[-100px] blur-3xl bg-cover backdrop-invert opacity-30" style="background-image: url({frog_gif})"></div>
